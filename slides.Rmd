...
params:
  event: "Data journalisme"
  slug: datajournalisme
---
...
* Identifier le **potentiel des données** pour du journalisme 
...
---
### Exemples de projet issu du cours

.pull-left[
![](https://soypelligseu.github.io/DPE-Nord/4.png)
]

.pull-right[

![](https://soypelligseu.github.io/DPE-Nord/6.png)

]

--> Voir le projet complet : https://soypelligseu.github.io/DPE-Nord/

---

### Un exemple issu d'autre cours 
...
--> Voir le projet complet : https://infogram.com/step-by-step-charts-1hzj4o7j1nm36pw?live

---

### Critères d'évaluation

Les séances en cours servent à faire avancer vos projets. A l'issue du cours, vous publierez un article sur l'agora de Marsactu. 

Les critères d'évaluation seront les suivants, à part égale : 

* L'article **développe un angle bien précis** et argumente des idées, tout en pointaint les limites des données

* Les données sont bien choisies, traitées et leur traitement est bien documenté et expliqué

* Les visualisations sont claires, explicites et font avancer l'argumentation

* L'article nous aide à mieux comprendre des aspects du territoire et ouvre la porte vers de nouvelles pistes.
...
---
### 5 intentions dans l'analyse de données 
...
.footnote[Source : Patrick Marcel, 2021, [Action MADONA, premiers résultats](https://drive.google.com/file/d/1cgvW82RusC_H0t33Oql6Aamvio239DNR/view)]
---
